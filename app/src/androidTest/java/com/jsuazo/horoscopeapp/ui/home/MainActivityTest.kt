package com.jsuazo.horoscopeapp.ui.home
...
import com.jsuazo.horoscopeapp.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    fun when_mainActivity_is_created_then_open_luck_fragment() {
        onView(withId(com.jsuazo.horoscopeapp.R.id.luckFragment)).perform(click())
    }
